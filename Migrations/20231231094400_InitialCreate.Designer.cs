...
namespace OnlineCommercialAutomation.Migrations
{
    ...
    [Migration("20231231094400_InitialCreate")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("OnlineCommercialAutomation.Customer", b =>
                {
                    ...
                    b.Property<int>("SalesMoveSalesId")
                        .HasColumnType("int");

                    b.HasKey("CustomerId");

                    b.HasIndex("SalesMoveSalesId");
            ...
            modelBuilder.Entity("OnlineCommercialAutomation.Customer", b =>
                {
                    b.HasOne("OnlineCommercialAutomation.SalesMove", "SalesMove")
                        .WithMany("Customers")
                        .HasForeignKey("SalesMoveSalesId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("SalesMove");
                });
